    ...
    I: Clone + Clone,
{
    ...
    pub fn with_field(
        ...
        Ok(match self {
            Direction::FromProto(_) => Direction::FromProto(FromProtoFieldInfo::from_field(field)?),
            Direction::IntoProto(_) => Direction::IntoProto(IntoProtoFieldInfo::from_field(field)?),
        })
    }
}
